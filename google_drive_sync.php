    ...
    if (!empty($file_id)) {
        ...
        if (!empty($fileData)) {
            ...
            if (!empty($_SESSION['google_access_token'])) {
                ...
                $data = $GoogleDriveApi->GetAccessToken('447895701363-7i69vk9ahsg4kfp0e86cqr2bn5lc1lbj.apps.googleusercontent.com', 'https://localhost/drive/google_drive_sync.php', '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', '4/0AX4XfWi_fq7ouP_rmXvnTbCRxpTnfbLFObJtqqTK2jE7tIGrysbH5IKQhTEUsg8uKQ40ew');
